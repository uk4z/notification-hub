...
class FibonacciHeap:
    ...
    def insertion(self, wrap, key):
        ...
        if self.max_node is None or new_node.key > self.max_node.key:
    ...
    def have_wrap(self, wrap):
        ...
        return dfs_node(self.max_node, wrap) is not None

    def extract_max(self):
        extract_node = self.max_node
        ...
        if extract_node is not None:
            ...
            if extract_node == extract_node.right:
                ...
                self.max_node = extract_node.right
                self.consolidate()

            self.nb_nodes -= 1
            
            return (extract_node.wrap, extract_node.key)
    ...
    def _get_node_by_wrap(self, wrap):
        ...
        return dfs_node(self.max_node, wrap)
